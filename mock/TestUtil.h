 ...
 */
#ifndef _GOPHERWOOD_MOCK_TESTUTIL_H_
#define _GOPHERWOOD_MOCK_TESTUTIL_H_
...
#define DebugException(function) \
    try { \
        function ; \
    } catch (const Gopherwood::GopherwoodException & e) { \
        std::string buffer; \
        LOG(LOG_ERROR, "DEBUG:\n%s", Gopherwood::Internal::GetExceptionDetail(e, buffer)); \
        throw; \
