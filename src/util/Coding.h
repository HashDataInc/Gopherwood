...
extern void PutVarint32Varint32(std::string *dst, int32_t value1, int32_t value2);

extern void PutVarint32Varint32Varint32(std::string *dst, int32_t value1, int32_t value2,
        int32_t value3);

extern void PutVarint64(std::string *dst, int64_t value);

extern void PutVarint64Varint64(std::string *dst, int64_t value1, int64_t value2);

extern void PutVarint32Varint64(std::string *dst, int32_t value1, int64_t value2);

extern void PutVarint32Varint32Varint64(std::string *dst, int32_t value1, int32_t value2,
        int64_t value3);
...
extern const char *GetVarint32PtrFallback(const char *p, const char *limit, int32_t *value);

inline const char *GetVarint32Ptr(const char *p, const char *limit, int32_t *value) {
    if (p < limit) {
...
inline void PutVarint32Varint32Varint32(std::string *dst, int32_t v1, int32_t v2, int32_t v3) {
    char buf[15];
    char *ptr = EncodeVarint32(buf, v1);
    ptr = EncodeVarint32(ptr, v2);
...
inline void PutVarint32Varint32Varint64(std::string *dst, int32_t v1, int32_t v2, int64_t v3) {
    char buf[20];
    char *ptr = EncodeVarint32(buf, v1);
    ptr = EncodeVarint32(ptr, v2);
...
inline void PutLengthPrefixedSliceParts(std::string *dst, const SliceParts &slice_parts) {
