 ...
 */
#ifndef _GOPHERWOOD_COMMON_LOGGER_H_
#define _GOPHERWOOD_COMMON_LOGGER_H_
...
#define LOG(s, fmt, ...) \
    Gopherwood::Internal::RootLogger.printf(s, fmt, ##__VA_ARGS__)

#endif /* _GOPHERWOOD_COMMON_LOGGER_H_ */
